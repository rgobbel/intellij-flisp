...
public class FlDottedImpl extends FlPFormImpl implements FlDotted {

  public FlDottedImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FlispVisitor visitor) {
    visitor.visitDotted(this);
  }
  ...
  @Override
  @Nullable
  public FlReaderMacro getReaderMacro() {
    return findChildByClass(FlReaderMacro.class);
  }
